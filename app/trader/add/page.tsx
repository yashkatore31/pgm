...
export default function AddTraderPage() {
    ...
    return (
        <div className="bg-white px-2 sm:px-4 py-6">
            <div className="max-w-md sm:max-w-lg mx-auto border rounded-lg shadow-md p-4 sm:p-6 bg-white">
                <h1 className="text-2xl font-bold mb-6 text-center text-gray-800">Add New Trader</h1>
