...
export default function EditTraderPage() {
    ...
    return (
        <div className="my-20 mx-3 bg-white flex items-center justify-center px-2 sm:px-4 py-6 sm:py-12">
            <div className="w-full max-w-md sm:max-w-lg border rounded-lg shadow-md p-4 sm:p-6 bg-white">
